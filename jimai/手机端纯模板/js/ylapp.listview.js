ylapp.define("listview", function($, exports, module) {
...
<%}%>\
    ...
    var thinLineTmp = ylapp.view.template(model_thinLine);
    var groupLineTmp = ylapp.view.template(model_groupLine);
    var thickLineTmp = ylapp.view.template(model_thickLine);
    var viewid = 1;
    function isWindows() {
    ...
    Listview.prototype = {
        buildListview : function(data,group) {
            ...
            ylapp.switchBtn(switchBtns, function(obj, value) {
                var ele = obj.parent();
