  ...
  <div class="tab-pane fade in active" id="home">
      ...
      <div class="form-group">
          ...
          <div class="col-md-2 has-error">
                <select class="form-control" data-placeholder="Select..." name="CustomerService" style="width:70px">
                <option value="1" selected="">86</option>
                <option value="2" selected="">85</option>
                <option value="3" selected="">84</option>
                </select>
          </div>
          <div class="col-md-6 has-error">
                <input type="text" class="form-control input-medium" maxlength="50" required="" name="nickname" placeholder="请输入您的手机号">
          </div>
      </div>
      <div class="form-group">
          <label class="control-label col-md-3">短信验证码</label>
          <div class="col-md-6 has-error">
              <input type="text" class="form-control input-medium" maxlength="50" required="" name="nickname" placeholder="请输入短信验证码">
          </div>
          <div class="col-md-3 has-error">
              <button type="button" class="btn btn-default" maxlength="50" required="" name="nickname">获取验证码</button>
          </div>
      </div>
      <div class="form-group">
