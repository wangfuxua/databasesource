...
//http://zy/m/template/article_imgintro_list.php?classid=29
...
<div class="article_ny">
	...
	{
	?>
		<div class="List clearfix"> <a href="<?=$rs['url'.$LT]?cadd($rs['url'.$LT]):'/m'.pathLT($rs['path'])?>"  target="_blank" ><img class="img" src="<?=ImgAdd($rs['img'.$LT])?>"></a>    
			<div class="article">
				<a href="<?=$rs['url'.$LT]?cadd($rs['url'.$LT]):'/m'.pathLT($rs['path'])?>" target="_blank"  style="color:<?=cadd($rs['titlecolor'])?>"><?=cadd($rs['title'.$LT])?></a>
